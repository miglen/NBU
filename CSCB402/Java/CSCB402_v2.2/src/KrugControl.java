...
/**
 * The Class KrugControl.
 */
public class KrugControl extends JPanel implements ActionListener {
    ...
    /**
     * Instantiates a new krug control.
     */
    public KrugControl(){
        
        label = new JLabel();
        label.setText("Позиция на кръга");
    ...
    private void setSize(int size) throws PropertyVetoException {       
        ...
        fireVetoableChange("krug", this.old_size, size);
        firePropertyChange("krug", this.old_size, size);
